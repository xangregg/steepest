...
function render() {
    ...
    const withFields = state.roads.map(r => {
        ...
        r.listed = false; // set on listed roads (they wear red on the map vs indigo)
        return r;
    });
    ...
    if (rankMode === 'climb') {
        ...
        // Listed climbs wear red on the map; everything else steep is indigo,
        ...
        // provenance slices — and every other steep road goes indigo. The
        ...
        for (const e of entries) {
            ...
            // reads as part of this red section instead of an indigo wing.
            // The rest of the road goes indigo like any unlisted road.
        ...
        // ~25 m segment at ≥ 5 % shows in indigo, even on a road too short — or
